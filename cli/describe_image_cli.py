...
def main():
    ...
    parser.add_argument("--image",required=True,help="Insert path to image to process")
    parser.add_argument("--query", required=True, type=str, help="Query to pass to model")
